programa{
	...
	inteiro quantidadeAtualUsuarios = 0, opcao_menu, i, opcao
	...
	cadeia usuarioLogado = "", opcao_entrar, opcao_logoff, resposta
...
//	funcao inteiro pesquisarIndiceUsuario(cadeia nome)
	...
	funcao logico loginUsuario(){
		...
		se(validarLoginUsuario(usuario, senha)){
			...
			escreva("FALHA: usuário e senha inválidos.\n")
			u.aguarde(500)
			loginUsuario()
			fim = falso
			retorne falso
