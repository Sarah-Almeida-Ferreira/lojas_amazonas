...
*/
	...
	funcao imprimirCarrinho(){
		...
		se(faturaParcialGuloseimas > 0){
			escreva("Subtotal de guloseimas: ",faturaParcialGuloseimas) 
		...
		se(faturaParcialVestuario > 0){
			escreva("Subtotal de vestuário: ",faturaParcialVestuario) 
		...
		se(faturaParcialEletronicos > 0){
			escreva("Subtotal de eletrônicos: ",faturaParcialEletronicos) 
			faturaCarrinho = faturaCarrinho + faturaParcialEletronicos
		}senao{
			escreva("Nenhum Eletrônico\n")
		}
		se(faturaCarrinho>0){
			escreva("\nValor Total: R$",faturaCarrinho)
		}senao{
			escreva("Carrinho vazio")
		}
	}	
	funcao logico finalizarCompra(){
